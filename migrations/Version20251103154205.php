 ...
 */
final class Version20251103154205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE instrument ADD marque_id INT DEFAULT NULL, ADD date_achat DATE DEFAULT NULL, ADD prix_achat DOUBLE PRECISION DEFAULT NULL, CHANGE type_instrument_id type_instrument_id INT DEFAULT NULL, CHANGE num_serie num_serie VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE instrument DROP marque_id, DROP date_achat, DROP prix_achat, CHANGE type_instrument_id type_instrument_id INT NOT NULL, CHANGE num_serie num_serie VARCHAR(255) NOT NULL');
    }
}
