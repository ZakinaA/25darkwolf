 ...
 */
final class Version20251015071721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat_pret (id INT AUTO_INCREMENT NOT NULL, intervention_id INT NOT NULL, eleve_id INT DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, attestation_assurance TINYINT(1) NOT NULL, etat_detaille_debut LONGTEXT NOT NULL, etat_detaille_retour LONGTEXT NOT NULL, INDEX IDX_1FB84C678EAE3863 (intervention_id), INDEX IDX_1FB84C67A6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cours ADD type_instrument_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours DROP type_instrument_id');
    }
}
