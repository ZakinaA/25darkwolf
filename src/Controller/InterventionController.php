...
final class InterventionController extends AbstractController
{
    ...
    {
        // ATTENTION : C'est la ligne critique. Elle doit utiliser findAllWithRelations()
        // et non pas findAll()
        $interventions = $interventionRepository->findAllWithRelations();
        
        return $this->render('intervention/index.html.twig', [
            // La clé ici DOIT être 'interventions' (au pluriel)
